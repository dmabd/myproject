...
<link rel="stylesheet"
    ...
    <title>My JSP 'tianxie.jsp' starting page</title>
  ...
  <body>
    ...
    <div class="content">
        ...
        <div class="content-block">
            ...
            <div class="row">
                <div class="col-50">
                    <a href="SellerAction!fanhui.action"
                        class="button button-big button-fill button-danger" id="back">返回商品管理</a>
                </div>
                <div class="col-50">
                    <a href="SellerAction!fanhui.action" class="button button-big button-fill" id="submit">提交</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type='text/javascript' src='js/productoperation.js' charset='utf-8'></script>
